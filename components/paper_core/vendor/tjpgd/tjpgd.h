...
/* PAPER private decoder: isolated from LVGL's RGB/no-scale configuration. */
#define LV_USE_TJPGD 1
#define jd_prepare paper_jd_prepare
#define jd_decomp paper_jd_decomp
#define jd_mcu_load paper_jd_mcu_load
#define jd_mcu_output paper_jd_mcu_output
#define jd_restart paper_jd_restart
#include "tjpgdcnf.h"
