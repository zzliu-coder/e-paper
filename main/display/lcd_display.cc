...
#include <esp_psram.h>
#include <cstring>
// LVGL 9.5 中，lv_image_cache_* 已从公开头移动到 cache 私有头。
...
void LcdDisplay::SetChatMessage(const char* role, const char* content) {
    ...
    // LVGL 9.5：公开 API 用 lv_text_get_size（lv_txt_get_width 兼容宏已失效）
    lv_point_t text_size{};
    lv_text_get_size(&text_size, content, text_font, 0, 0, LV_COORD_MAX, LV_TEXT_FLAG_NONE);
    lv_coord_t text_width = text_size.x;
